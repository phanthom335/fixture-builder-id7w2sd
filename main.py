        """
        Fixture Builder Id7w2sd
        =======================
        Developer-friendly pipeline tool built to deduplicate data at every processing stage.
...
from pathlib import Path
        ...
        APP_NAME    = "Fixture Builder Id7w2sd"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly pipeline tool built to deduplicate data at every processing stage.")
